...
optimizer = torch.optim.Adam(model.parameters(), lr=0.00120)
...
for epoch in range(120):  # Train for 100 epochs
    ...
    print(f"Epoch [{epoch+1}/120], Loss: {epoch_loss/len(dataloader):.3f}")
