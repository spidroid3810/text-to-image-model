...
optimizer_G = torch.optim.Adam(generator.parameters(), lr=0.0001)  # Generator optimizer
optimizer_D = torch.optim.Adam(discriminator.parameters(), lr=0.0001)  # Discriminator optimizer
